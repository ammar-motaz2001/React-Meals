...
export default function AreaDetails() {
    ...
    try {
        let data=await fetch(`https://www.themealdb.com/api/json/v1/1/filter.php?a=${para.id}`)
  ...
  return (
    <>
     <div key={3} className='grid grid-cols-1 peo md:grid-cols-2 w-full lg:grid-cols-2'>
        {data.map(item=>{
          return <Fade>
